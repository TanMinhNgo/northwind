 ...
 */
function buildTrSegment({ w, h, q = 80, f = "auto", crop, watermark = false }: { w?: number; h?: number; q?: number; f?: string; crop?: "at_max" | "maintain_ratio"; watermark?: boolean } = {}) {
  const parts = [];
 ...
 */
export function imageKitOptimizedUrl(url: string | null | undefined, opts: { w?: number; h?: number; q?: number; f?: string; crop?: "at_max" | "maintain_ratio"; watermark?: boolean } = {}) {
 ...
 */
export function imageKitWatermarkedUrl(url: string | null | undefined, opts: { w?: number; h?: number; q?: number; f?: string; crop?: "at_max" | "maintain_ratio"; watermark?: boolean } = {}) {
