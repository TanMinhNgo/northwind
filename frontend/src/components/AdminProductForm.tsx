...
export function AdminProductForm({ initial, saving, error, getToken, onCancel, onSubmit }: any) {
  ...
  async function handleImageUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (file.size > 10 * 1024 * 1024) {
      setUploadError("File is too large (max 10MB)." as any);
      return;
    }
    ...
    try {
      ...
      setUploadError(err instanceof Error ? err.message : "Upload failed" as any);
    } finally {
